...
{
    private readonly GetBookingStatusByIdQueryValidator _validator;

    public GetBookingStatusByIdQueryValidatorTests()
    {
        _validator = new GetBookingStatusByIdQueryValidator();
    }
