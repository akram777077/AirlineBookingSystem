...
namespace AirlineBookingSystem.UnitTests.Features.Terminals.Queries.SearchTerminals;

public class SearchTerminalsQueryValidatorTests
{
    private readonly SearchTerminalsQueryValidator _validator;

    public SearchTerminalsQueryValidatorTests()
    {
        _validator = new SearchTerminalsQueryValidator();
    }
