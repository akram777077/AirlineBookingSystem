...
namespace AirlineBookingSystem.Persistence.Migrations
{
    ...
    [Migration("20250613150203_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirlineBookingSystem.Domain.Entities.Passenger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AirlineBookingSystem.Domain.Entities.Address", b =>
                {
                    ...
                    b.HasOne("AirlineBookingSystem.Domain.Entities.Country", "Country")
                        .WithOne()
                        .HasForeignKey("AirlineBookingSystem.Domain.Entities.Address", "CountryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AirlineBookingSystem.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("AirlineBookingSystem.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
                    ...
                    b.HasOne("AirlineBookingSystem.Domain.Entities.Passenger", "Passenger")
                        .WithMany()
            ...
            modelBuilder.Entity("AirlineBookingSystem.Domain.Entities.Passenger", b =>
                {
                    b.HasOne("AirlineBookingSystem.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("AirlineBookingSystem.Domain.Entities.Passenger", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
