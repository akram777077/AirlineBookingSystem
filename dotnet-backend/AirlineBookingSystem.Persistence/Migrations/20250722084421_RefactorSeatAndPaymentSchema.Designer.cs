...
namespace AirlineBookingSystem.Persistence.Migrations
{
    ...
    [Migration("20250722084421_RefactorSeatAndPaymentSchema")]
    partial class RefactorSeatAndPaymentSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AirlineBookingSystem.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("AirlineBookingSystem.Domain.Entities.Seat", "Seat")
                        .WithOne("Booking")
                        .HasForeignKey("AirlineBookingSystem.Domain.Entities.Booking", "SeatId");
